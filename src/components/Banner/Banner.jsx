...
const Banner = () => {
    ...
    return (
        ...
        <div className="md:h-[550px] h-[350px] bg-gradient-to-r from-teal-400 to-blue-500   rounded-bl-xl space-y-5 text-center rounded-br-xl text-white">
            <h1 className="lg:text-6xl md:text-4xl text-3xl font-bold w-[95%] pt-6 md:w-[80%] mx-auto ">Upgrade Your Tech Accessorize with Gadget Heaven Accessories</h1>
        ...
        <div className='top-[300px] absolute w-full'>
